...
# Usage:
# /applications/R/R-3.4.0/bin/Rscript features_EnrichedHeatmap_sorted_by_sRNAs_Mutator_DTM.R CS+_2_LIB18613_LDI16228 2000 Mutator_DTM 1400 2000 2kb '2 kb' 20 20bp 20 promoters

#libName <- "CS+_2_LIB18613_LDI16228"
#featureNumber <- 2000
#featureName <- "Mutator_DTM"
#bodyLength <- 1400
#upstream <- 2000
#downstream <- 2000
#flankName <- "2kb"
...
foreach(x = 1:5) %dopar% {
  sRNA_col_fun <- colorRamp2(quantile(c(sRNAmatsSorted[[x]]),
                                      c(0.9992, 0.9993, 0.9994, 0.9995, 0.9996, 0.9997),
                                      na.rm = T),
                             rich8to6equal)
...
# 33-nt sRNAs
  sRNA_col_fun <- colorRamp2(quantile(c(sRNAmatsSorted[[6]]),
                                      c(0.999895, 0.999900, 0.999905, 0.999910, 0.999915, 0.999920),
                                      na.rm = T),
                             rich8to6equal)
...
# 34-nt sRNAs
  sRNA_col_fun <- colorRamp2(quantile(c(sRNAmatsSorted[[7]]),
                                      c(0.99991, 0.99992, 0.99993, 0.99994, 0.99995, 0.99996),
                                      na.rm = T),
                             rich8to6equal)
